...
public class JhipsterSampleMongodbApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleMongodbApp.class);

    private final Environment env;

    public JhipsterSampleMongodbApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleMongodb.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleMongodbApp.class);
